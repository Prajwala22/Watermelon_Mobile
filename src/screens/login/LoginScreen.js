     ...
     <TouchableOpacity  onPress={() => goToForgotpassword()}>
      ...
      <TouchableOpacity onPress={(handleSubmitPress)}>
        <View style={[styles.saveButtonFooter]}>
          <Button style={[styles.primaryBg, styles.saveBtn, styles.width100]}><Text style={[styles.font15, styles.letterSpa33, styles.textWhite, styles.fontMed]}>Sign In</Text></Button>
        </View>
      </TouchableOpacity>
