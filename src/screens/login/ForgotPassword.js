  ...
  <View style={GlobalStyles.mainContainer}>
    <View style={GlobalStyles.logo}>
      ...
      <View style={GlobalStyles.inputView}>
          <Text style={GlobalStyles.labelText}>Registered Email Address</Text>
     ...
     <TouchableOpacity style={GlobalStyles.loginBtn} onPress={handleSubmit(onSubmit)}>
       <Text style={GlobalStyles.loginText} onPress={handleSubmit(onSubmit)}>Send</Text> 
     </TouchableOpacity>          
      </View>
      </View>
